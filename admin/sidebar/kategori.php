<?php
/**
 * Kategori Content (untuk ditampilkan di dashboard.php)
 */
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <?php while ($row = $kategori_list->fetch_assoc()): ?>
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <a href="dashboard.php?page=kategori&delete=<?php echo $row['id']; ?>" class="text-red-600 hover:text-red-700 font-medium text-sm" onclick="return confirm('Yakin ingin menghapus?')">
                                        Hapus
                                    </a>
                                </td>
                            </tr>
